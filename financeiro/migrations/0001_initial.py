    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('descricao', models.CharField(max_length=200)),
                ('valor', models.DecimalField(decimal_places=2, max_digits=10)),
                ('categoria', models.CharField(choices=[('hospedagem', 'Hospedagem'), ('aluguel', 'Aluguel de Ponto Comercial'), ('freela', 'Serviços Freelancer'), ('eventos', 'Eventos'), ('produtos', 'Venda de Produtos'), ('outros', 'Outros')], max_length=20)),
